...
export default function ContactPage() {
  ...
  const inputClass =
    "w-full bg-transparent border border-white/[0.08] px-4 py-3 font-mono text-[13px] tracking-[0.06em] text-white placeholder:text-white/20 focus:outline-none focus:border-[#4a6cf7]/50 transition-colors";
      ...
      <div className="pt-32 pb-24 px-6 md:px-10">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="font-mono text-[13px] tracking-[0.04em] text-white/30 leading-relaxed max-w-md mb-12">
            We&apos;ll walk you through what we&apos;d run, who we&apos;d reach, and whether you&apos;re eligible.
          </p>
