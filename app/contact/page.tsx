      ...
      <div className="pt-20 md:pt-32 pb-24 px-6 md:px-10">
        <div className="max-w-2xl mx-auto">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 md:gap-5">
              ...
              <input
                type="text"
                name="company"
                placeholder={t("companyField", lang)}
                value={form.company}
                onChange={handleChange}
                className={inputClass}
                style={{ boxShadow: "0 0 16px rgba(255,255,255,0.06)" }}
              ...
              >
                ...
                {/* Invisible sizer */}
                <span className="invisible px-10">{t("submit", lang)}</span>
              </button>
            </form>
          )}
          ...
          <div className="flex items-center gap-3 mt-8 pt-8" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <span className="font-mono text-[10px] tracking-[0.1em] uppercase" style={{ color: "rgba(255,255,255,0.3)" }}>{t("or", lang)}</span>
            <a
