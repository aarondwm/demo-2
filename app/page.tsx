        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          ...
          <div className="mb-14">
            <div className="rule-accent mb-5">
              <span className="sys-label"><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>What We Do</span>
            </div>
            <h2
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="flex flex-col gap-8">
              <div className="rule-accent mb-5">
                <span className="sys-label"><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>Secured Media Placement</span>
              </div>
              <h2
                className="font-display font-bold uppercase"
                style={{ fontSize: "clamp(36px,5vw,60px)", letterSpacing: "0.05em", lineHeight: "0.93" }}
      ...
      <section id="intelligence" className="sys-section">
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-12 items-end">
            <div>
              <div className="rule-accent mb-5">
                <span className="sys-label" style={{ color: "#7a8598" }}><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>Intelligence, Delivered</span>
              </div>
              <h2
                className="font-display font-bold uppercase text-white"
                style={{ fontSize: "clamp(36px,5vw,60px)", letterSpacing: "0.05em", lineHeight: "0.93" }}
          ...
          <div className="relative w-full bg-white/[0.02] border border-white/[0.08] overflow-hidden">
            ...
            <div className="p-10 md:p-14 grid md:grid-cols-2 gap-12 items-center">
              <div className="flex flex-col gap-6">
                <span className="sys-label block" style={{ color: "#7a8598" }}><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>Audience Intelligence</span>
                <h3
                  className="font-display font-bold uppercase text-white"
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <div className="mb-14 text-center">
            <div className="rule-accent-center mb-5">
              <span className="sys-label"><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>Who We Work With</span>
            </div>
            <h2
              className="font-display font-bold uppercase text-white"
              style={{ fontSize: "clamp(36px,5vw,60px)", letterSpacing: "0.05em", lineHeight: "0.93" }}
          ...
          <div className="border border-white/[0.08] bg-white/[0.02] p-12 md:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              <div className="rule-accent mb-7">
                <span className="sys-label"><span style={{ color: "#4a6cf7", marginRight: "8px" }}>د</span>Get Started</span>
              </div>
              <h2
