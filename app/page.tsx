    ...
    <main className="relative min-h-screen bg-black grain">
      ...
      <section id="home" className="relative pt-[72px]" style={{ backgroundColor: "#060a14" }}>
        ...
        <div className="relative z-10 flex flex-col items-center px-6 py-24 md:py-36 gap-6">
          ...
          >
            <HoverActionButton label="Request a Briefing" href="#get-started" variant="white" className="text-[15px] font-bold rounded-2xl py-6 w-64 !bg-transparent" />
            <HoverActionButton label="How It Works" href="#what-we-do" variant="white" direction="vertical" className="text-[15px] font-bold rounded-2xl py-6 w-64 !bg-transparent" />
          </div>
        </div>
      </section>
