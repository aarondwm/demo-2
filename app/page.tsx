...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-black grain">
      ...
      {/* WhatsApp floating button — expands on hover */}
      <a
        ...
        onMouseEnter={(e) => { e.currentTarget.style.width = "190px"; e.currentTarget.style.gap = "10px"; }}
      ...
      >
        ...
        <span style={{ color: "#fff", fontSize: "13px", fontWeight: 700, letterSpacing: "0.04em", whiteSpace: "nowrap", opacity: 0, transition: "opacity 0.2s ease 0.1s" }} className="group-hover:!opacity-100">Contact Us</span>
      </a>
