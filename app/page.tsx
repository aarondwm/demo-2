...
const DASH_COMPANIES = [
  { rank: "01", name: "Saudi Aramco", views: 3420, blur: false },
  { rank: "02", name: "Emirates NBD", views: 2810, blur: false },
  { rank: "03", name: "SABIC Industries", views: 2340, blur: true },
  { rank: "04", name: "Qatar Energy Corp", views: 1980, blur: true },
  { rank: "05", name: "Etisalat Group", views: 1640, blur: false },
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            ...
            {DASH_SENIORITY.map((s, i) => (
              <div key={s.level} className="flex items-center gap-2 md:gap-3">
                ...
                <span className="font-mono font-bold flex-shrink-0 w-[50px] md:w-[60px] text-right" style={{ fontSize: "11px", color: "#4a6cf7" }}>{s.count.toLocaleString()}</span>
              </div>
            ))}
          </div>
        )}
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            {DASH_INDUSTRIES.map((ind, i) => (
              <div key={ind.name} className="flex items-center gap-2 md:gap-3">
                <span className="font-mono w-[110px] md:w-[160px] flex-shrink-0 truncate" style={{ fontSize: "11px", color: "rgba(255,255,255,0.6)" }}>{ind.name}</span>
                <div className="flex-1 h-[6px] rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.04)" }}>
          ...
          <div className="flex flex-col gap-0">
            ...
            {DASH_COMPANIES.map((c, i) => (
              <div key={c.rank} className="flex items-center gap-2 md:gap-3 py-2 md:py-2.5 border-b border-white/[0.03]" style={{ opacity: i < 5 ? 1 : 0.6 }}>
                ...
                <span className="font-mono font-bold flex-shrink-0 w-[40px] md:w-[50px] text-right" style={{ fontSize: "11px", color: "rgba(255,255,255,0.7)" }}>{c.views}</span>
              </div>
            ))}
