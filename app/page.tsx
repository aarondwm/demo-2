    ...
    <main className="relative min-h-screen bg-black grain">
      ...
      <section id="home" className="relative pt-[72px]" style={{ backgroundColor: "#060a14" }}>
        ...
        <div className="relative z-10 flex flex-col items-center px-6 py-14 md:py-24 lg:py-36 gap-6">
          ...
          >
            <HoverActionButton labelText={t("requestBriefing", lang)} scramble href={lang === "ar" ? "/ar/contact" : "/contact"} variant="blue-fill" className={`!flex md:!inline-flex ${lang === "ar" ? "text-[22px] md:text-[24px]" : "text-[11px] md:text-[15px]"} font-bold w-full md:w-80 hero-btn`} style={{ borderRadius: "999px", padding: "28px 0", background: "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.05) 100%)", backdropFilter: "blur(48px) saturate(200%) brightness(1.2)", WebkitBackdropFilter: "blur(48px) saturate(200%) brightness(1.2)", borderColor: "rgba(255,255,255,0.30)", boxShadow: "0 0 0 1px rgba(255,255,255,0.15) inset, 0 1px 0 0 rgba(255,255,255,0.20) inset, 0 -1px 0 0 rgba(255,255,255,0.05) inset, 0 4px 30px rgba(255,255,255,0.06) inset, 0 16px 48px rgba(0,0,0,0.4)" }} />
            <HoverActionButton labelText={t("howItWorks", lang)} scramble scrambleStep={6.2} href="#what-we-do" variant="white" direction="vertical" className={`!flex md:!inline-flex ${lang === "ar" ? "text-[22px] md:text-[24px]" : "text-[11px] md:text-[15px]"} font-bold w-full md:w-80 hero-btn`} style={{ borderRadius: "999px", padding: "28px 0", background: "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.05) 100%)", backdropFilter: "blur(48px) saturate(200%) brightness(1.2)", WebkitBackdropFilter: "blur(48px) saturate(200%) brightness(1.2)", borderColor: "rgba(255,255,255,0.30)", boxShadow: "0 0 0 1px rgba(255,255,255,0.15) inset, 0 1px 0 0 rgba(255,255,255,0.20) inset, 0 -1px 0 0 rgba(255,255,255,0.05) inset, 0 4px 30px rgba(255,255,255,0.06) inset, 0 16px 48px rgba(0,0,0,0.4)" }} />
          </div>
        </div>
      </section>
      ...
      >
        ...
        <span style={{ color: "#fff", fontSize: "16px", fontWeight: 700, letterSpacing: "0.06em", whiteSpace: "nowrap", opacity: 0, transition: "opacity 0.2s ease 0.1s", lineHeight: "56px" }} className="group-hover:!opacity-100">Contact Us</span>
      </a>
