  ...
  return (
    <main className="relative min-h-screen bg-black grain">
      ...
      <a
        ...
        onMouseLeave={(e) => { e.currentTarget.style.width = "56px"; e.currentTarget.style.gap = "0px"; e.currentTarget.style.background = "#25D366"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,0,0,0.3), 0 0 20px rgba(37,211,102,0.4), 0 0 40px rgba(37,211,102,0.2)"; }}
      >
