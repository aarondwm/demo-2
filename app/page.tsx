...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-black grain">
        ...
        <div className="relative z-10 flex flex-col items-center px-6 py-14 md:py-24 lg:py-36 gap-6">
          ...
          >
            <div className="flex items-center justify-center w-full text-center">
              <span className="sys-label" style={{ fontSize: lang === "ar" ? "20px" : "16px", letterSpacing: "0.3em", textAlign: "center" }}><ScrambleOnView text={t("heroLabel", lang)} delay={0} style={{ display: "inline" }} /></span>
            </div>
          </div>
          ...
          >
            <HoverActionButton labelText={t("requestBriefing", lang)} scramble href={lang === "ar" ? "/ar/contact" : "/contact"} variant="blue-fill" className={`!flex md:!inline-flex ${lang === "ar" ? "text-[26px] md:text-[28px]" : "text-[11px] md:text-[15px]"} font-bold w-full md:w-80 hero-btn`} style={{ borderRadius: "999px", padding: "28px 0", background: "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.05) 100%)", backdropFilter: "blur(48px) saturate(200%) brightness(1.2)", WebkitBackdropFilter: "blur(48px) saturate(200%) brightness(1.2)", borderColor: "rgba(255,255,255,0.30)", boxShadow: "0 0 0 1px rgba(255,255,255,0.15) inset, 0 1px 0 0 rgba(255,255,255,0.20) inset, 0 -1px 0 0 rgba(255,255,255,0.05) inset, 0 4px 30px rgba(255,255,255,0.06) inset, 0 16px 48px rgba(0,0,0,0.4)" }} />
            <HoverActionButton labelText={t("howItWorks", lang)} scramble scrambleStep={6.2} href={lang === "ar" ? "/ar#what-we-do" : "#what-we-do"} variant="white" direction="vertical" className={`!flex md:!inline-flex ${lang === "ar" ? "text-[26px] md:text-[28px]" : "text-[11px] md:text-[15px]"} font-bold w-full md:w-80 hero-btn`} style={{ borderRadius: "999px", padding: "28px 0", background: "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.05) 100%)", backdropFilter: "blur(48px) saturate(200%) brightness(1.2)", WebkitBackdropFilter: "blur(48px) saturate(200%) brightness(1.2)", borderColor: "rgba(255,255,255,0.30)", boxShadow: "0 0 0 1px rgba(255,255,255,0.15) inset, 0 1px 0 0 rgba(255,255,255,0.20) inset, 0 -1px 0 0 rgba(255,255,255,0.05) inset, 0 4px 30px rgba(255,255,255,0.06) inset, 0 16px 48px rgba(0,0,0,0.4)" }} />
          </div>
        </div>
      </section>
      ...
      <section id="what-we-do" className="sys-section">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 text-center lg:text-left">
          ...
          <div className="flex items-center justify-center lg:justify-start mb-5" style={{ direction: lang === "ar" ? "rtl" : "ltr" }}>
            <span className="sys-label" style={{ fontSize: lang === "ar" ? "20px" : "16px", letterSpacing: "0.3em" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-4 lg:gap-16 items-start">
            ...
            <div className="flex flex-col gap-4 lg:gap-8 text-center lg:text-left items-center lg:items-start">
              <div className="flex items-center mb-2 lg:mb-5" style={{ direction: lang === "ar" ? "rtl" : "ltr" }}>
                <span className="sys-label" style={{ fontSize: lang === "ar" ? "20px" : "16px", letterSpacing: "0.3em" }}><img src="/Untitled design.png" alt="" style={{ width: "18px", height: "18px", marginInlineEnd: "12px", display: "inline-block", verticalAlign: "middle", mixBlendMode: "screen" }} /><ScrambleOnView text={t("securedMediaPlacementTitle", lang)} delay={0} style={{ display: "inline" }} onDone={sec3Done} /></span>
              </div>
              <h2
                className="font-bold uppercase"
      ...
      <section id="sample-insights" className="sys-section">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10 text-center lg:text-left">
            ...
            <p className="sys-body md:text-right md:max-w-xs mx-auto lg:mx-0" style={{ fontFamily: "var(--font-body), sans-serif", fontSize: lang === "ar" ? "18px" : "16px", lineHeight: 1.7, color: "rgba(255,255,255,0.7)", direction: lang === "ar" ? "rtl" : undefined, textAlign: lang === "ar" ? "right" : undefined }}>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <div className="mb-10 text-center">
            <div className="flex items-center justify-center mb-5">
              <span className="sys-label" style={{ fontSize: lang === "ar" ? "20px" : "16px", letterSpacing: "0.3em" }}><img src="/Untitled design.png" alt="" style={{ width: "18px", height: "18px", marginRight: "8px", display: "inline-block", verticalAlign: "middle", mixBlendMode: "screen" }} /><ScrambleOnView text={t("whoWeWorkWith", lang)} delay={0} style={{ display: "inline" }} onDone={sec5Done} /></span>
            </div>
            <h2
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <div className="border border-white/[0.08] bg-white/[0.02] p-6 md:p-12 lg:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="sys-body max-w-lg mb-10 mx-auto text-center cta-desc" style={{ opacity: secCtaVisible ? 1 : 0, transition: "opacity 0.35s ease 0.25s", fontSize: lang === "ar" ? "18px" : "16px", direction: lang === "ar" ? "rtl" : undefined }}>
              ...
              <div className="flex justify-center" style={{ opacity: secCtaVisible ? 1 : 0, transition: "opacity 0.35s ease 0.32s" }}>
                <HoverActionButton label={t("requestBriefing", lang)} href={lang === "ar" ? "/ar/contact" : "/contact"} className={lang === "ar" ? "!text-[20px] !h-16" : ""} />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* WhatsApp floating button — expands on hover (desktop only) */}
      <a
        ...
        style={{
          ...
          boxShadow: "0 4px 16px rgba(0,0,0,0.3), 0 0 20px rgba(74,108,247,0.4), 0 0 40px rgba(74,108,247,0.2)",
          transition: "all 0.35s cubic-bezier(0.16,1,0.3,1)",
          width: "56px",
          overflow: "hidden",
          textDecoration: "none",
        }}
        onMouseEnter={(e) => { e.currentTarget.style.width = "175px"; e.currentTarget.style.gap = "10px"; e.currentTarget.style.background = "#4a6cf7"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,0,0,0.3), 0 0 20px rgba(74,108,247,0.4), 0 0 40px rgba(74,108,247,0.2)"; }}
        onMouseLeave={(e) => { e.currentTarget.style.width = "56px"; e.currentTarget.style.gap = "0px"; e.currentTarget.style.background = "#4a6cf7"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,0,0,0.3), 0 0 20px rgba(74,108,247,0.4), 0 0 40px rgba(74,108,247,0.2)"; }}
      >
        ...
        <span style={{ color: "#fff", fontSize: "16px", fontWeight: 700, letterSpacing: "0.06em", whiteSpace: "nowrap", opacity: 0, transition: "opacity 0.2s ease 0.1s", lineHeight: "56px" }} className="group-hover:!opacity-100">{lang === "ar" ? "تواصل معنا" : "Contact Us"}</span>
      </a>
      {/* WhatsApp — mobile (simple circle, no hover expand) */}
      <a
        href="https://wa.me/96566457010?text=whats%20up%20cuzzeh"
        target="_blank"
        rel="noopener noreferrer"
