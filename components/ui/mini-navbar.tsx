    ...
    >
      ...
      <div className="mx-auto w-full px-6 md:px-10 h-16 flex items-center justify-between gap-6">
        ...
        >
          ...
          />
          <span className="ml-2 font-bold uppercase tracking-[0.08em]" style={{ fontFamily: "'Neue Montreal', var(--font-display), sans-serif", fontSize: lang === "ar" ? "clamp(20px, 4vw, 24px)" : "clamp(10px, 2.5vw, 17px)", color: "#e8e8e8" }}>{lang === "ar" ? "ديوانية ميديا" : "Diwaniya Media"}</span>
        </a>
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <a
            ...
            className={`group inline-flex items-center h-9 font-mono text-[13px] uppercase font-bold relative overflow-hidden`}
            style={{ borderRadius: "12px", transform: "translateZ(0)", textDecoration: "none", letterSpacing: lang === "en" ? "0" : "0.14em" }}
          >
            ...
            <span className="absolute inset-0 flex items-center justify-center duration-700 ease-[cubic-bezier(0.50,0.20,0,1)] -translate-x-full group-hover:translate-x-0 z-10" style={{ background: "#4a6cf7", borderRadius: "12px" }}>
              <span style={{ color: "#fff", fontSize: "13px", letterSpacing: lang === "en" ? "0" : "0.14em", fontWeight: 700, textTransform: "uppercase" }}>{lang === "en" ? "عربي" : "EN"}</span>
            </span>
            <span className="absolute inset-0 flex items-center justify-center text-white transition-opacity duration-300 group-hover:opacity-0 z-20" style={{ letterSpacing: lang === "en" ? "0" : "0.14em" }}>
              {lang === "en" ? "عربي" : "EN"}
            </span>
            <span className="invisible px-5" style={{ letterSpacing: lang === "en" ? "0" : "0.14em" }}>{lang === "en" ? "عربي" : "EN"}</span>
          </a>
